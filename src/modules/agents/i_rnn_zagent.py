...
class IRNNZAgent(nn.Module):
    def __init__(self, input_shape, args):
        super(IRNNZAgent, self).__init__()
        self.args = args
        ...
        self.fc2 = nn.ModuleList([nn.Linear(args.rnn_hidden_dim, args.n_actions * args.quantiles_num) for _ in range(self.args.n_agents)])
    ...
    def forward(self, inputs, hidden_state):
        ...
        q = torch.cat(q,1).reshape(-1,self.args.n_actions,self.args.quantiles_num)
        return q, h
